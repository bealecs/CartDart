...
export default function UpgradeAccount() {
  return (
    <div className="bg-background h-screen">
      <Navbar />
      <div className="mt-24 text-center md:w-7/12 lg:w-6/12 xl:w-4/12 p-4 md:border-2 rounded-lg mx-auto">
        ...
        <div className="bg-btn-background transition duration-300 linear hover:bg-btn-background-hover w-10/12 mx-auto rounded-lg my-8 p-4 text-xl">
          <a href="https://buy.stripe.com/14k14RaN6d3M93O144" target="_blank" rel="noopener noreffer">Upgrade Now</a>
        </div>
