    ...
    <div>
      ...
      {menuOpen ? <div className="w-screen h-fit bg-gray-900 absolute top-0 z-10 p-4 border-b-2 border-b-white">
        ...
        <ul className="my-4">
          ...
          <li onClick={handleClick} className="my-2"><a className="transition duration-300 linear border-b-transparent border-b-2 hover:border-b-gray-400 hover:text-gray-400 w-fit text-2xl" href="https://discord.gg/7xt5eKdYc3" target="_blank" rel="ref noopener">Report an Issue</a></li>
